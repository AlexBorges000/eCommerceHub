...
namespace BlazorShop.Api.Migrations
{
    ...
    [Migration("20260712130721_TPT_Usuario")]
    partial class TPT_Usuario
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlazorShop.Api.Entities.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorShop.Api.Entities.Usuario", b =>
                {
                    b.HasOne("BlazorShop.Api.Entities.Role", "Role")
                        .WithMany("Usuario")
